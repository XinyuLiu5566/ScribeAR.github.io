     ...
     var choice = if_ins ? 'appear' : 'disappear';
       return (
            <div className="Options" id="options-space">
                <h2 style = {{fontFamily:"Arial"}}>Media</h2>

                <h3>Email and Donwload</h3>
                <Divider></Divider>
                <div>
                ...
                <div>
                <Button variant="contained" variant="text" onClick={new Recognition().uploadFile} startIcon={<FontIcon iconName="onedrive-svg" className={iconClass}/>}>onedrive upload</Button>
                </div>
                
                <div class = "onenote">
                <Button variant="text" startIcon = {<FontIcon iconName="onenote-svg" className={iconClass}/>}>onenote upload</Button>
                </div>
                <br></br>
                <br></br>
                <br></br>
